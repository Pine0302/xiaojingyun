...
$destination_folder = "../../../".Base_Upload."Order/stores/";  
...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
 ...
 //echo "<script>location.href='addcardshop_image.php?customer_id=".$customer_id_en."&shop_imgurl=".$save_destination."';</script>";
 
 $data['status'] = 'ok';
$data['info'] = $save_destination;
