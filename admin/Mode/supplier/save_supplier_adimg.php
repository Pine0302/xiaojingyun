...
$destination_folder = "../../../".Base_Upload."Mode/supplier/";  
...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
 ...
 echo "<script>location.href='supplier_adimg.php?customer_id=".$customer_id_en."&microshop_adimg=".$save_destination."&num=".$num."';</script>";
 }
?>