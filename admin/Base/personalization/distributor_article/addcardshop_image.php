...
<form action="save_distritor_article_image.php?customer_id=<?php echo $customer_id_en; ?>&article_id=<?php echo $article_id; ?>" id="frm_img" enctype="multipart/form-data" method="post">
