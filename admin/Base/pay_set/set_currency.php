...
$currency = 0;
$query = "SELECT currency FROM weixin_commonshop_user_currency where isvalid=true and user_id=".$user_id." order by id asc LIMIT 1";
...
<title><?php echo defined('PAY_CURRENCY_NAME')? PAY_CURRENCY_NAME: '购物币'; ?>充值</title>
			...
			<form action="save_set_currency.php?customer_id=<?php echo $customer_id_en; ?>&user_id=<?php echo $user_id;?>" enctype="multipart/form-data" method="post" id="upform" name="upform" onSubmit="return subBase()">
				<div class="WSY_remind_main">
					...
					<div class="WSY_text_input">
						<button style="display:inline-block;float:left;margin:30px 10px 30px 10%;" class="WSY_button" >保存</button>
