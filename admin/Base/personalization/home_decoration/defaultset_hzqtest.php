...
<script type="text/javascript" src="../../../Common/js/Base/personalization/shop_new.js?v=<?php echo time();?>"></script>
...
<?php }else if($template_id==28){?>
  ...
  <link href="../../../Common/css/Base/home_decoration/bao/css/index.css" rel="stylesheet" type="text/css">
	...
	<script type="text/javascript" src="js/shop_new.js"></script>
				...
				<div class="WSY_microbox WSY_single1 " id="setimages">
					...
					<dl class="WSY_micro" style="margin-top:35px!important">
					   ...
					   <!--上传文件代码结束-->
						...
						<dd><input type="text" id="search_link" /><span class="search-btn">搜索</span></dd>
					   <dd><input  type="radio" name="sel_link_type" id="sel_link_type_2_1" value="1" /> <span>链接页面：</span>
						...
						<input type=hidden name="selector_id" id="selector_id" value="-1" />
						</dd>
						<dd>
							<input type="radio" name="sel_link_type" id="sel_link_type_2_2" value="2" /> <span>填写链接：</span>
							<input type="text" name="custom_link_2" id="custom_link" value="" style="width:175px;" />
						</dd>
						</div>
			...
			<script>
				...
				<div class="WSY_microbox WSY_single2" id="set_title">
					...
					<dl class="WSY_micro">
					   ...
					   <dd>
					   <div class="url_select" style="display: block;">
						<input type="text" id="search_link" /><span class="search-btn">搜索</span>
					   <input type="radio" name="sel_link_type" id="sel_link_type_3_1" value="1" /> <span class="show_typebox">链接页面：</span>
						<select  name="type_id_3"  id="type_id_3"  onchange="change_type(this);">
						...
						<input type="text" name="custom_link_3" id="custom_link" value="" style="width:175px;" />
						</div>
				...
				<div class="WSY_slide WSY_single3"  id="setbanner">
					<div class="WSY_microbox WSY_microslide">
                        ...
                        <button type="button" class="link-choose" onclick="showSelector(this)">请选择</button>
						<input type=hidden name="selector_id_1" id="selector_id" value="-1" />

						<input type="radio" name="sel_link_type_1" id="sel_link_type_1_1_2" value="2" /> <span>填写链接：</span>
						<input type="text" name="custom_link_1_1" id="custom_link" value="" style="width:175px;" />
						<div class="clear"></div>
								</dd>
							</dl>
						</div>
					...
					<div class="WSY_microbox WSY_microslide">
						...
						<input type="text" name="custom_link_1_2" id="custom_link" value="" style="width:175px;" />
						<div class="clear"></div>
								</dd>
							</dl>
						</div>
					...
					<div class="WSY_microbox WSY_microslide">
						...
						<input type="text" name="custom_link_1_3" id="custom_link" value="" style="width:175px;" />
						<div class="clear"></div>
								</dd>
							</dl>
						</div>
					...
					<div class="WSY_microbox WSY_microslide">
						...
						<input type="text" name="custom_link_1_4" id="custom_link" value="" style="width:175px;" />
						<div class="clear"></div>
								</dd>
							</dl>
						</div>
					...
					<div class="WSY_microbox WSY_microslide">
						...
						<input type="text" name="custom_link_1_5" id="custom_link" value="" style="width:175px;" />
						<div class="clear"></div>
								</dd>
							</dl>
						</div>
				...
				<div class="item">
					...
					<div class="rows url_select" style="display: block;">
					   ...
					   <input type="radio" name="sel_link_type_<?php echo $num; ?>" id="sel_link_type_1_<?php echo $num; ?>_2" value="2" disabled /> <span>填写链接：</span>
						<input type="text" name="custom_link_1_<?php echo $num; ?>" id="custom_link" value="" style="width:175px;" readonly />
					</div>
					<div class="clear"></div>
				</div>
   ...
   var customer_id_en = '<?php echo $customer_id_en; ?>';
	...
	function showSelector(obj){
		...
		layer.open({
			  ...
			  resize:true,
			  title: '选择链接页面',
			  content: '/mshop/admin/index.php?m=plug_link_selector&a=selector_list&customer_id='+customer_id_en,
		});
	}
	//选择链接回调函数
