...
$superior_id = "";  //父ID
if(!empty($_GET["superior_id"])){
	$superior_id = $configutil->splash_new($_GET["superior_id"]);
}
...
$content ='';//文章内容
// echo $content;
$qurey_content = "SELECT name,sort,content,superior_id FROM pc_help_center_t WHERE id =".$id." and customer_id=".$customer_id." and isvalid=1";
...
<!--内容框架-->
	<div class="WSY_content">
		...
		<div class="WSY_columnbox">
			...
			<!--列表头部切换结束-->
            <!--关注用户开始-->
            <form action="article_management_substrate.php?customer_id=<?php echo $customer_id_en;?>"  method="post" id="upform" name="upform">
              <div id="products">
                  <div class="WSY_data" id="WSY_dataddbox">
                  	<input type="hidden" value='<?php echo $op;?>' name="op">
					<input type="hidden" value='<?php echo $id;?>' name="id">
					<input type="hidden" value='<?php echo $superior_id;?>' name="superior_id">
...
<script>
	...
	function submitV(){
        ...
        // win_alert(list);return;
			...
			$.ajax({
				url: 'article_management_substrate.php',
