...
<form action="save_microshop_adimg.php?customer_id=<?php echo $customer_id_en; ?>&id=<?php echo $id; ?>&num=<?php echo $num; ?>" id="frm_typeimg" enctype="multipart/form-data" method="post">
			...
			<p style=" padding-left: 10px;">上传1张图片，微店首页广告图片。图片大小建议：640*640像素</p>
...
<a href="del_microshop_adimg.php?customer_id=<?php echo $customer_id_en; ?>&id=<?php echo $id; ?>&num=<?php echo $num; ?>"><div class="del"><span style="color:#FFFFFF">删除</span></div></a>
<?php 
...
<script type="text/javascript">  
	...
	parent.setTypeImg('<?php echo $adimg[$i]; ?>',<?php echo $i; ?>,0);
