	...
	<div class="content-box">
		<table>
			...
			<tbody>
				<?php
				    //运费模板信息 
					$query_temid="SELECT id,expresses_name,is_default,createtime,print_temp_id FROM weixin_expresses_company where isvalid=true and customer_id=".$customer_id." and supply_id=-1";
					if($search_keyword){
				...
				<tr >
					...
					<td style="border-right: none;">
						<a style="margin-right: 8px;" href="express_company_add.php?customer_id=<?php echo passport_encrypt((string)$customer_id);?>&tem_id=<?php echo $tem_id;?>&title=<?php echo $title;?>&print_temp_id=<?php echo $print_temp_id;?>&op=update">
