function search_condition(url){
	...
	var search_user_id = document.getElementById("search_user_id").value;//搜索用户id
    ...
    var search_sendstyle = document.getElementById("search_sendstyle").value;//配送方式
	...
	/*郑培强*/
	/*郑培强*/ 
	if(document.getElementById("shopactivity_mark")){
		var shopactivity_mark=document.getElementById("shopactivity_mark").value;
	}else{
		var shopactivity_mark=0;
	}
	/*郑培强*/ 
    ...
    var if_search_time = 1;
    if(from_page == 1) {
        var store_lev = document.getElementById("store_lev").value;//订货系统仓库级别
        var search_or_shop_id = document.getElementById("search_or_shop_id").value;//订货系统门店ID
        // var search_or_shop_name = document.getElementById("search_or_shop_name").value;//订货系统门店名
    }
	var url2="&search_class="+search_class+"&pagesize="+pagesize+"&search_name_type="+search_name_type+search_integral_str+"&if_search_time="+if_search_time;
	if(begintime !=""){
	...
	if(search_user_id !=""){
		url2=url2+"&search_user_id="+search_user_id;
	}
    ...
    if(search_sendstyle !=""){
		url2=url2+"&search_sendstyle="+search_sendstyle;
	}
	if(search_supply_id !=""){
	...
	if(shopactivity_mark !=""){ 
		url2=url2+"&shopactivity_mark="+shopactivity_mark;
	} 
	/*郑培强*/
	if(orgin_from !=""){
    ...
    if(from_page == 1) {
        if (store_lev != "") {
            url2 = url2 + "&store_lev=" + store_lev;
        }
        
        if (search_or_shop_id != "") {
            url2 = url2 + "&search_or_shop_id=" + search_or_shop_id;
        }
        
        /*if (search_or_shop_name != "") {
            url2 = url2 + "&search_or_shop_name=" + search_or_shop_name;
        }*/
    }
