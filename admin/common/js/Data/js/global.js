...
var global_obj={
  ...
  function show_newOrder(customer_id){
     document.location = "order.php?customer_id="+customer_id;
  }
  function show_todayMoney(customer_id){
     document.location = "order.php?customer_id="+customer_id+"&search_status=3";
  }
  
  function show_newCustomer(customer_id){
     document.location = "customers.php?customer_id="+customer_id;
  }
  function show_newQrsell(customer_id){
     document.location = "qrsell.php?customer_id="+customer_id;
  }  
  function show_stock(customer_id,stock_pidarr){
     document.location = "stock_product.php?customer_id="+customer_id+"&stock_pidarr="+stock_pidarr;
  }
