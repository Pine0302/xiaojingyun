...
<div class="WSY_column_header1">
	<div class="WSY_columnnav1">
		<ul>			
			<li value="0"><a href="/mshop/admin/index.php?m=cailing&a=basic_settings">基本设置</a></li>
			<li value="1"><a href="/mshop/admin/index.php?m=cailing&a=color_bell_management">彩铃管理</a></li>			
			<li value="2"><a href="/mshop/admin/index.php?m=cailing&a=order_list_management">订单管理</a></li>			
		</ul>
	</div>
</div>
<script>
