        ...
        <div class="WSY_data">
            <div class="WSY_agentsbox">
                <form class="search" id="search" style="display:block" method="get" action="/mshop/admin/index.php">
                    <input type="hidden" id="m" name="m" value="navigation">
                    ...
                    <ul class="WSY_search_q">
                        ...
                        <li>模板名称：<input type="text" name="name" id="template_name" value="<?php if($condition['name']!=""){echo $condition['name'];}?>" class="form_input"></li>
                        <li>创建时间：
...
<script type="text/javascript">
    ...
    $(".WSY_page").createPage({
        ...
        current:pagenum,
        backFn:function(p){
            var url="/mshop/admin/index.php?m=navigation&a=template_list&pagenum="+p+param;
            location.href = url;
        }
    });
    ...
    function jumppage(){
        ...
        if((a<1) || (a>count) || isNaN(a)){
            ...
            var url="/mshop/admin/index.php?m=navigation&a=template_list&pagenum="+a+param;
            location.href = url;
        }
    }
    ...
    function operate(template_id,type){
        ...
        var remark = "";
        if(type==1){
            url = '/mshop/admin/index.php?m=navigation&a=template_release';
            remark = "模板上架需关联发布页面，确认后即可关联。";
        }else if(type==2){
            url = '/mshop/admin/index.php?m=navigation&a=template_off_shelve';
            remark = "模板下架后导航无法显示，确认吗？";
        }else if(type==3){
            url = '/mshop/admin/index.php?m=navigation&a=template_del';
            remark = "模板删除后不可恢复，确定吗？";
        }else if(type==4){
            url = '/mshop/admin/index.php?m=navigation&a=template_release&do=show';
//            remark = "模板上架后导航会在已关联页面显示，确认吗？";
        }
        if(type == 4){
    ...
    function jump_url(template_id,type){
        ...
        var url = "";
        if(type==1){
            url = "/mshop/admin/index.php?m=navigation&a=template_edit&id="+template_id;
        }else if(type==2){
            url = "/mshop/admin/index.php?m=navigation&a=template_add";
        }else if(type==3){
            url = "/mshop/admin/index.php?m=navigation&a=icon_list&id="+template_id;
        }
        location.href = url;
    }
</script>
