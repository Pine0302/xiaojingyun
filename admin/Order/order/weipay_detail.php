...
$price				= 0;
$weipay = "select total_fee,transaction_id from weixin_weipay_notifys where isvalid=true and out_trade_no='".$pay_batchcode."'";
	...
	<div class="WSY_columnbox">
		...
		<div class="WSY_remind_main" style="min-height:250px;">
			...
			<dl class="WSY_remind_dl02" id="div_return" style="display:none;margin-top:20px;margin-left:100px;">
				...
				<dd class="WSY_bottonli con-button" style="float:left;margin-left:80px;"> <input id="subReturn" value="退款"  type="button" onclick="subReturn(this);" /></dd>
			</dl>
			<?php  }else{  ?>
...
function subReturn(obj){
   ...
   if(paystyle=="兴业银行公众号支付"){
	   ...
	   document.location = "/weixinpl/common_shop/jiushop/refund.php?customer_id=<?php echo $customer_id_en; ?>&pay_batchcode=<?php echo $pay_batchcode; ?>&total_fee=<?php echo $price; ?>&batchcode=<?php echo $batchcode?>&out_trade_no=<?php echo $out_trade_no; ?>&refund_fee=" + return_money + "&transaction_id=<?php echo $transaction_id;?>";
   }
   }
</script>
