...
<div class="WSY_column_header1">
	<div class="WSY_columnnav1">
		<ul>
			<li value="0"><a href="/mshop/admin/index.php?m=queue&a=queue_activity">队列活动</a></li>
			<li value="1"><a href="/mshop/admin/index.php?m=queue&a=queue_count&isout=1">活动统计</a></li>			
		</ul>
	</div>
</div>
<script>
