...
//include_once($_SERVER['DOCUMENT_ROOT'].'/weixinpl/back_newshops/Base/personalization/home_decoration/pink_selector_url.php'); //8.25-
include_once($_SERVER['DOCUMENT_ROOT'].'/mshop/admin/Base/personalization/home_decoration/pink_selector_url.php');  //8.26+
