...
$destination_folder="../../../../".Base_Upload."Base/personalization/distributor_article"; //上传文件路径
...
$time=time();
if( $key_id ){
	$query="update weixin_commonshop_distributor_article set description='$description',share_img='$imgurl' ,title='$title',share_description='$share_description',p_id=$p_id where id=$key_id";
}else{
	$query="insert into weixin_commonshop_distributor_article (customer_id,description,title,time,share_description,p_id,share_img) values ($customer_id,'$description','$title',$time,'$share_description',$p_id,'$imgurl')";
}
