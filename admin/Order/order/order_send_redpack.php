...
$result= _mysql_query($query) or die('Query failed 19: ' . mysql_error());
	...
	<div class="WSY_columnbox" style="min-height: 300px;">
		...
		<table width="97%" class="WSY_table WSY_t2" id="WSY_t1">
			<thead class="WSY_table_header">
				...
				$query  = "select l.id_new as id, l.user_id,u.weixin_name as username,l.remark,l.reward,l.paytype,l.batchcode,l.card_member_id,l.level_name,l.createtime,l.own_user_name,l.paytype,l.type,l.commission_type,l.commission_score from weixin_commonshop_order_promoters l inner join weixin_users u on l.user_id = u.id where u.isvalid = true and l.isvalid = true and l.batchcode = '".$batchcode."'";
                ...
                <tr>
				   ...
				   <td align="center"><?php if($commission_type == 1)echo $reward;else echo $commission_score; ?></td>
				   <!-- <td align="center"><?php echo $type == 1 ? "积分" : "金额"; ?></td> -->
				   <td align="center"><?php echo $commission_type == 1 ? "金额" : "积分"; ?></td>
				   ...
				   <td align="center">
					<p>
					<?php 
						if(1<=$reward&&$reward<=200&&$istype == 0  && $paytype != 10 && $commission_type ==1 ){
						?>
