...
$_pic = $pcshop->getLastNewPic();
$default_pic = 'static/img/upic.jpg'; 
if(isset($_GET['newpic'])&&$_GET['newpic']=='yes') 
$flag = 1;
//上传图片
...
<script type="text/javascript" src="<?php echo $pcshop->http;?>/weixin/plat/Public/ckeditor/ckeditor.js"></script>
<script type="text/javascript" src="<?php echo $pcshop->http;?>/weixin/plat/Public/ckfinder/ckfinder.js"></script>
<script type="text/javascript" src="<?php echo $pcshop->http;?>/weixin/plat/Public/js/jquery.dragsort-0.5.2.min.js"></script>
<script type="text/javascript" src="<?php echo $pcshop->http;?>/weixin/plat/Public/swfupload/swfupload/swfupload.js"></script>
<script type="text/javascript" src="<?php echo $pcshop->http;?>/weixin/plat/Public/swfupload/js/swfupload.queue.js"></script>
<script type="text/javascript" src="<?php echo $pcshop->http;?>/weixin/plat/Public/swfupload/js/fileprogress.js"></script>
<script type="text/javascript" src="<?php echo $pcshop->http;?>/weixin/plat/Public/swfupload/js/handlers.js"></script>
				...
				<div class="WSY_remind_main">
					...
					<dl class="WSY_member">			
						<div>
							<dt>产品图片：</dt>						
							<dd class="spa">
								<img src="<?php if(!$flag){echo $default_pic;}else{if($_pic){echo $_pic;}else{echo $default_pic;}}?>" id="img_v1" style="width:220px;height:200px;"/><br/>
								<input type="file" name="upfile_goods" id="upfile_goods" value="" style="width:208;border:1 solid #9a9999;font-size:9pt;background-color:#ffffff;height:18;margin-top:5px;margin-bottom:5px;" size="17"> (图片尺寸：宽220*高200)
								<input type="hidden" name="imgurl_goods" id="imgurl_goods" value="<?php echo $left_img; ?>"/> 
							</dd>
						</div>
					</dl>
					...
					<dl class="WSY_member">			
						<div>
							<dt>产品类别：</dt>		
							<dd><?php echo $pcshop->catetype();?></dd>
						</div>
					</dl>
					...
					<dl class="WSY_member">			
						<div>
							...
							<dd><textarea name="goods_descc" id="goods_descc"></textarea></dd>
						</div>
					</dl>

                    <!-- 富文本编辑器 -->
				    <dl> 
						<dd class="text">产品详情：</dd>
						<dd class="textarea" style="margin-left:6%;">
							<!-- <textarea id="textarea"></textarea> -->
							<div class="yirenForm text_box input description" style="margin:5px 0 0 0;width:98%;">
								<textarea id="textarea" name="text_content"></textarea>
							</div>
						</dd>
						<dd class="tip_nc_desc" style="color:rgb(221,80,68)"></dd>
					</dl>
...
var _http = "<?php echo $pcshop->http;?>";
/*插入写字板开始*/
CKEDITOR.replace('textarea',{
	extraAllowedContent:'img iframe[*]',
	filebrowserBrowseUrl:_http+'/weixin/plat/Public/ckfinder/ckfinder.html',
	filebrowserImageBrowseUrl:_http+'/weixin/plat/Public/ckfinder/ckfinder.html?Type=Images',
	filebrowserFlashBrowseUrl:_http+'/weixin/plat/Public/ckfinder/ckfinder.html?Type=Flash',
	filebrowserUploadUrl:_http+'/weixin/plat/Public/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files',
	filebrowserImageUploadUrl:_http+'/weixin/plat/Public/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images',
	filebrowserFlashUploadUrl:_http+'/weixin/plat/Public/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash'
});
/*插入写字板结束*/
 ...
 var deal = '';
 function subBase(){
 	//var text_content = $('.cke_wysiwyg_frame').contents().find('body').html(); //获取文本编辑器内容
	var imgurl_num = $('.spa').length;
	$('#img_num').val(imgurl_num);
	var title = $("[name=goods_title]").val();
	var goods_descc = $("#goods_descc").val();
	var parent_id = $("[name=parent_id][id=parent_id]").val();
	if(title==""){
		alert("标题不能为空！");
		return false;
	}	
