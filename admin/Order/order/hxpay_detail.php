...
$sendstatus = 0;
$query="select status,paystatus,sendstatus,return_status,payother_trade_no,paystyle,paytime  from weixin_commonshop_orders where isvalid=true and batchcode='".$batchcode."' group by batchcode";
...
$price              = 0;
$weipay = "select total_fee,ipsbillno from weixin_hxpay_notifys where isvalid=true and out_trade_no='".$pay_batchcode."'";
...
while ($row_result_weipay = mysql_fetch_object($result_weipay)) {
    $transaction_id = $row_result_weipay->ipsbillno;
    ...
    <div class="WSY_columnbox">
        ...
        <div class="WSY_column_header">
            <div class="WSY_columnnav">
                <a class="white1"><?php echo $paystyle;?>详情</a>
            </div>
        </div><br />
        <!--列表头部切换结束-->
        ...
        <div class="WSY_remind_main" style="min-height:250px;">
            ...
            <dl class="WSY_remind_dl02" style="margin-top:20px;margin-left:100px;">
                <dt style="line-height:20px;" class="WSY_left">环迅交易单号：</dt>
                <dd><span class="input">
            ...
            <dl class="WSY_remind_dl02" style="margin-top:20px;margin-left:100px;">
                <dt style="line-height:20px;" class="WSY_left"><?php echo $paystyle?>：</dt>
                <dd><span class="input">
                    <?php  echo $price; ?>
                </span></dd>
            </dl>
            ...
            ?>
                ...
                <dl class="WSY_remind_dl02" style="margin-top:20px;margin-left:100px;">
                    <label>已退款金额：</label>
                    <span class="input">
                        <?php echo $refund ? $refund.$currency_text : "0".$currency_text; ?>
                    </span>
                </dl>
                <dl class="WSY_remind_dl02" style="margin-top:20px;margin-left:100px;">
                    <label></label>
...
function subReturn(){
   ...
   document.location = "../../../../wsy_pay/web/IPSpay/order_refund.php?total_fee=<?php echo $price; ?>&batchcode=<?php echo $batchcode?>&out_trade_no=<?php echo $out_trade_no?>&refund_fee=" + return_money + "&paytime=<?php echo $paytime;?>&industry_type=shop&customer_id=<?php echo $customer_id;?>";
