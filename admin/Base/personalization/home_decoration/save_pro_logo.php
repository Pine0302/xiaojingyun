...
//$destination_folder = "../../../".Base_Upload."Product/group/"; 
//$destination_folder="../../../../../up/pro_logo/"; //上传文件路径
$destination_folder = "../../../../".Base_Upload."Base/personalization/common_type/";
...
// $save_destination = "/weixinpl/".$save_destination;
 ...
 //echo $parent_id;
 //echo $destination;
// echo "<script>alert(".$save_destination.")</script>";
// echo "<script>alert(".$filename.")</script>";
 echo "<script>location.href='product_type_catimg.php?customer_id=".$customer_id_en."&type_imgurl=".$save_destination."&keyid=".$keyid."';</script>";
 }
?>