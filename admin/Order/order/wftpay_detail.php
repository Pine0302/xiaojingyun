...
$wft_type = $configutil->splash_new($_GET["wft_type"]);
//echo $wft_type;
...
$price				= 0;
$wftpay = "select price,callBackBatchcode from paycallback_t where isvalid=true and pay_batchcode='".$pay_batchcode."'";
$result_wftpay = _mysql_query($wftpay) or die('Query_weipay failed: ' . mysql_error());
while ($row_result_wftpay = mysql_fetch_object($result_wftpay)) {
	$transaction_id = $row_result_wftpay->callBackBatchcode;
	$price = $row_result_wftpay->price;
}
$totalprice		= 0;
$score			= 0;
...
function subReturn(){
	...
	var wft_type = "<?php echo $wft_type; ?>";
   ...
   if( wft_type == 1 ){
   		document.location = "/weixinpl/common_shop/jiushop/refund_wftpay_wx.php?customer_id=<?php echo $customer_id_en; ?>&pay_batchcode=<?php echo $pay_batchcode; ?>&total_fee=<?php echo $price; ?>&batchcode=<?php echo $batchcode?>&out_trade_no=<?php echo $out_trade_no; ?>&refund_fee="+return_money+"&transaction_id=<?php echo $transaction_id;?>";
   }else{
   		document.location = "/weixinpl/common_shop/jiushop/refund_wftpay_alipay.php?customer_id=<?php echo $customer_id_en; ?>&pay_batchcode=<?php echo $pay_batchcode; ?>&total_fee=<?php echo $price; ?>&batchcode=<?php echo $batchcode?>&out_trade_no=<?php echo $out_trade_no; ?>&refund_fee="+return_money+"&transaction_id=<?php echo $transaction_id;?>";
   }
