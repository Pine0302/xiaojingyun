...
.WSY_search_q li{font-size:14px;}
</style>
<body>
<!-- 修改产品分类 begin -->
...
<div class="WSY_content" id="WSY_content_height">
    ...
    <div class="WSY_data">
		...
		下单时间：&nbsp;
			<a>
			<input type="text" class="Wdate" style="width:30%;border: 1px solid #ccc;height: 26px;"  onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});"  id="begintime" name="AccTime_S" value="<?php echo $begintime; ?>" >
			</a>-<a>
			<input type="text" class="Wdate" style="width:30%;border: 1px solid #ccc;height: 26px;"  onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});" id="endtime" name="AccTime_E" value="<?php echo $endtime; ?>" >
			</a>
		</li>
		<li style="width:10%;"> 
