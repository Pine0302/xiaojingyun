...
<div class="WSY_column_header1">
	<div class="WSY_columnnav1">
		<ul>			
			<li value="0"><a href="/mshop/admin/index.php?m=yundian&a=yundian_shopkeeper_list">店主列表</a></li>
			<li value="2"><a href="/mshop/admin/index.php?m=yundian&a=shopkeeper_review_list&customer_id<?php echo $customer_id_en?>">店主审核</a></li>
<!-- 			<li value="1"><a href="#">操作日志</a></li>	 -->		
		</ul>
	</div>
</div>
<script>
