...
// var_dump($_POST["is_submenu");exit();
// if($op!='checkTitle'){
...
if($op=="add"){
	//添加
	$query_add = "insert into pc_help_center_t(customer_id,name,superior_id,is_submenu,sort,isvalid,level,content)values(".$customer_id.",'".$name."',".$superior_id.",".$is_submenu.",".$sort.",1,2,'".$content."')";
//	  echo $query_add;exit();
