...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	//是否存在文件
	{
	   if($product_id<=0){
		...
		if(!file_exists($destination_folder)){
		  ...
		  if($image_size[0]!=640 || $image_size[1]!=640){
			   echo "<font color='red'>请上传尺寸为640*640的图片！</font>";
			   exit;
		  }
 ...
 echo "<script>location.href='microshop_adimg.php?customer_id=".$customer_id_en."&microshop_adimg=".$save_destination."&num=".$num."';</script>";
 }
?>