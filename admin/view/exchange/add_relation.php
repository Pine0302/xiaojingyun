        ...
        <div class="WSY_columnbox"> 
            ...
            <div class="WSY_data">
                <div class="WSY_agentsbox">
                    <form class="/mshop/admin/index.php?m=exchange&a=get_add_relation&activity_id=<?php echo $param['activity_id'];?>&pagenum=<?php echo $pageNum;?>" style="display:block" method="post" action="" enctype="multipart/form-data">
                        <ul class="WSY_search_q">
                            ...
                            <li>产品编码：<input type="text" name="product_id" value="<?php if($param['product_id']!=-1){echo $param['product_id'];}?>" class="form_input"></li>
                            <li>产品分类：
                    ...
                    <table width="97%" class="WSY_table" id="WSY_t1">
                        ...
                        <tbody class="tbody-main">
                            ...
                            <tr>
                                ...
                                <td><div class="tbody-typename ellipsis"><?php if ($row['is_QR'] == 1) {echo "/核销码产品";}   echo $row['typename'];?></div></td>
...
<script type="text/javascript">
    ...
    $('#btn').click(function(){
        ...
        $.ajax({
            url: '/mshop/admin/index.php?m=exchange&a=add_relation',
            dataType: 'json',
            type: 'post',
            data: {
    ...
    $(".WSY_page").createPage({
        ...
        current:pagenum,
        backFn:function(p){
            var url="/mshop/admin/index.php?m=exchange&a=get_add_relation&activity_id="+activity_id+"&pagenum="+p;    
            location.href = url;
       }
    });
    ...
    function jumppage(){
        ...
        if((a<1) || (a>count) || isNaN(a)){
            ...
            var url="/mshop/admin/index.php?m=exchange&a=get_add_relation&activity_id="+activity_id+"&pagenum="+a;    
            location.href = url;
        }
    }
    <!-- 分页 end -->
