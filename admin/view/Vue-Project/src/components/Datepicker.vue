    ...
    <div class="date-picker">
        <div class="input-wrapper" @mouseenter="showCancel = true" @mouseleave="showCancel = false">
            ...
            <transition name="fade">
                <img class="cancel-btn" src="../assets/cancel.png" v-show="showCancel" @click="clear">
            </transition>
        </div>
            ...
            <div class="date-panel" v-show="panelState" :style="coordinates">
                <div class="panel-header" v-show="panelType !== 'year'">
                    ...
                    <div class="year-month-box">
                        ...
                        <div class="month-box" @click="chType('month')">{{tmpMonth + 1 | month(language)}}月</div>
                    </div>
...
.date-picker:hover .input-wrapper {
    background: #FFF
}
