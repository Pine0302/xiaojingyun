/*
---
description: jBox is a powerful and flexible ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery plugin, taking care of all your modal windows, tooltips, notices and more.

authors: Stephan Wagner (//stephanwagner.me)

license: MIT (//opensource.org/licenses/MIT)

requires: ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery 1.11.1 (//code.jquery.com/jquery-1.11.1.min.js)
          ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery 2.1.1 (//code.jquery.com/jquery-2.1.1.min.js)
...
(function (root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery'], function (../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery) {
            return (root.jBox = factory(../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery));
        });
    
    // Node. Does not work with strict CommonJS, but only CommonJS-like enviroments that support module.exports, like Node
    } else if (typeof exports === 'object') {
        module.exports = factory(require('../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery'));
    
    // Browser globals
    } else {
        root.jBox = factory(root.../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery);
    }
}(this, function (../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery) {
	...
	var jBox = function (type, options) {
		...
		this.options = {
			...
			content: null,				// You can use a string to set text or HTML as content, or an element selector (e.g. ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('#jBox-content')) to append one or several elements (elements appended will get style display: 'block', so hide them with CSS style display: 'none' beforehand)
			...
			ajax: {						// Setting an url will make an AJAX call when jBox opens
				...
				// Optional you can add any ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery AJAX option (//api.jquery.com/jquery.ajax/)
			...
			appendTo: ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('body'), 	// Provide an element if you want the jBox to be positioned inside a specific element (only useful for fixed positions or when position values are numbers)
		...
		this.defaultOptions = {
			...
			'Modal': {
				target: ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(window),
				fixed: true,
				blockScroll: true,
				closeOnEsc: true,
			...
			'Confirm': {
				target: ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(window),
				fixed: true,
				attach: ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('[data-confirm]'),
				...
				_onCreated: function() {
					...
					this.footer = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('<div class="jBox-Confirm-footer"/>');
					../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('<div class="jBox-Confirm-button jBox-Confirm-button-cancel"/>').html(this.options.cancelButton).click(function() { this.options.cancel && this.options.cancel(); this.close(); }.bind(this)).appendTo(this.footer);
					this.submitButton = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('<div class="jBox-Confirm-button jBox-Confirm-button-submit"/>').html(this.options.confirmButton).appendTo(this.footer);
			...
			'Notice': {
				...
				_onOpen: function() {
					...
					../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.each(../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('.jBox-Notice'), function(index, el) {
						el = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(el);
			...
			'Image': {
				...
				width: 800,
				height: 533,
				attach: ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('[data-jbox-image]'),
				preventDefault: true,
				...
				_onInit: function() {
					...
					this.attachedElements && ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.each(this.attachedElements, function (index, item) {
						item = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(item);
					...
					var appendImage = function(gallery, id, preload, open) {
						if (../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('#jBox-image-' + gallery + '-' + id).length) return;
						
						var image = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('<div/>', {
						...
						var text = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('<div/>', {
					...
					var showLabel = function(gallery, id) {
						../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('.jBox-image-label.active').removeClass('active');
						../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('#jBox-image-label-' + gallery + '-' + id).addClass('active');
					};
					...
					this.showImage = function(img) {
						...
						if (img != 'open') {
							...
							../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('.jBox-image-pointer-prev, .jBox-image-pointer-next').css({display: (this.images[gallery].length > 1 ? 'block' : 'none')});
						}
						...
						if (../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('#jBox-image-' + gallery + '-' + id).length) {
							../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('#jBox-image-' + gallery + '-' + id).css({zIndex: this.imageZIndex++, opacity: 0}).animate({opacity: 1}, (img == 'open') ? 0 : this.options.imageFade);
							...
							var image = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('<img src="' + this.images[gallery][id].src + '">').load(function() {
						...
						(!../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('#jBox-image-' + gallery + '-' + next_id).length) && ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('<img src="' + this.images[gallery][next_id].src + '">').load(function() {
				...
				_onCreated: function() {
					...
					this.imageLabel = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('<div/>', {'id': 'jBox-image-label'}).appendTo(this.wrapper);
					this.wrapper.append(../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('<div/>', {'class': 'jBox-image-pointer-prev', click: function() { this.showImage('prev'); }.bind(this)})).append(../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('<div/>', {'class': 'jBox-image-pointer-next', click: function() { this.showImage('next'); }.bind(this)}));
				},
				_onOpen: function() {
					// Add a class to body so you can control the appearance of the overlay, for images a darker one is better
					../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('body').addClass('jBox-image-open');
					
					// Add key events
					../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(document).on('keyup.jBox-' + this.id, function(ev) {
				...
				_onClose: function() {
					../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('body').removeClass('jBox-image-open');
					
					// Remove key events
					../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(document).off('keyup.jBox-' + this.id);
				},
				_onCloseComplete: function() {
					// Hide all images
		...
		if (../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.type(type) == 'string') {
			this.type = type;
			type = this.defaultOptions[type] ? this.defaultOptions[type] : window['jBox' + type + 'Options'];
		}
		
		// Merge options
		this.options = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.extend(true, this.options, type, options);
		...
		../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.type(this.options.offset) != 'object' && (this.options.offset = {x: this.options.offset, y: this.options.offset});
		this.options.offset.x || (this.options.offset.x = 0);
		this.options.offset.y || (this.options.offset.y = 0);
		../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.type(this.options.adjustDistance) != 'object' ? (this.options.adjustDistance = {top: this.options.adjustDistance, right: this.options.adjustDistance, bottom: this.options.adjustDistance, left: this.options.adjustDistance}) : (this.options.adjustDistance = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.extend({top: 5, left: 5, right: 5, bottom: 5}, this.options.adjustDistance));
		
		// Save where the jBox is aligned to
		this.align = (this.options.outside && this.options.outside != 'xy') ? this.options.position[this.options.outside] : (this.options.position.y != 'center' && ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.type(this.options.position.y) != 'number' ? this.options.position.x : (this.options.position.x != 'center' && ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.type(this.options.position.x) != 'number' ? this.options.position.y : this.options.attributes.x));
		...
		this._createSVG = function(type, options) {
			...
			../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.each(options, function (index, item) {
		...
		this._isolateScroll = function(el) {
			if(!el || !../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(el).length) return;
		...
		this._create = function() {
			...
			// Create wrapper
			this.wrapper = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('<div/>', {
				id: this.id,
			...
			this.options.closeOnMouseleave && this.wrapper.mouseleave(function(ev) {
				...
				!this.source || !(ev.relatedTarget == this.source[0] || ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.inArray(this.source[0], ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(ev.relatedTarget).parents('*')) !== -1) && this.close();
			}.bind(this));
			...
			// Create container
			this.container = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('<div/>', {'class': 'jBox-container'}).appendTo(this.wrapper);
			
			// Create content
			this.content = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('<div/>', {'class': 'jBox-content'}).css({width: this.options.width, height: this.options.height, minWidth: this.options.minWidth, minHeight: this.options.minHeight, maxWidth: this.options.maxWidth, maxHeight: this.options.maxHeight}).appendTo(this.container);
			...
			if (this.options.closeButton) {
				this.closeButton = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('<div/>', {'class': 'jBox-closeButton jBox-noDrag'}).on('touchend click', function(ev) { this.isOpen && this.close({ignoreDelay: true}); }.bind(this));
			...
			if (this.options.pointer) {
				...
				this.pointer.element = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('<div/>', {'class': 'jBox-pointer jBox-pointer-' + this.pointer.position}).appendTo(this.wrapper);
				this.pointer.dimensions = {
					x: this.pointer.element.outerWidth(),
					y: this.pointer.element.outerHeight()
				};
				
				if (../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.type(this.options.pointer) == 'string') {
			...
			if (this.options.draggable) {
				var handle = (this.options.draggable == 'title') ? this.titleContainer : (this.options.draggable.length > 0 ? this.options.draggable : (this.options.draggable.selector ? ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(this.options.draggable.selector) : this.wrapper));
				handle.addClass('jBox-draggable').on('mousedown', function(ev) {
					if (ev.button == 2 || ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(ev.target).hasClass('jBox-noDrag') || ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(ev.target).parents('.jBox-noDrag').length) return;
					...
					../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(document).on('mousemove.jBox-draggable-' + this.id, function(ev) {
						this.wrapper.offset({
					...
					ev.preventDefault();
				}.bind(this)).on('mouseup', function() { ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(document).off('mousemove.jBox-draggable-' + this.id); }.bind(this));
		...
		this._attachEvents = function() {
			...
			this.options.closeOnEsc && ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(document).on('keyup.jBox-' + this.id, function(ev) { if (ev.keyCode == 27) { this.close({ignoreDelay: true}); }}.bind(this));
			
			// Closing event: closeOnClick
			if (this.options.closeOnClick === true || this.options.closeOnClick == 'body') {
				../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(document).on('touchend.jBox-' + this.id + ' click.jBox-' + this.id, function(ev) {
			...
			if (((this.options.adjustPosition && this.options.adjustTracker) || this.options.reposition) && !this.fixed && this.outside) {
				...
				(this.options.adjustTracker && this.options.adjustTracker != 'resize') && ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(window).on('scroll.jBox-' + this.id, function(ev) { positionDelay(); }.bind(this));
				
				// Trigger position events when resizing
				((this.options.adjustTracker && this.options.adjustTracker != 'scroll') || this.options.reposition) && ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(window).on('resize.jBox-' + this.id, function(ev) { positionDelay(); }.bind(this));
			}
			
			// Mousemove events
			this.options.target == 'mouse' && ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('body').on('mousemove.jBox-' + this.id, function(ev) { this._positionMouse(ev); }.bind(this));
		};
		...
		this._detachEvents = function() {
			...
			// Closing event: closeOnEsc
			this.options.closeOnEsc && ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(document).off('keyup.jBox-' + this.id);
			
			// Closing event: closeOnClick
			(this.options.closeOnClick === true || this.options.closeOnClick == 'body') && ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(document).off('touchend.jBox-' + this.id + ' click.jBox-' + this.id);
			
			// Positioning events
			if ((this.options.adjustPosition && this.options.adjustTracker) || this.options.reposition) {
				../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(window).off('scroll.jBox-' + this.id);
				../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(window).off('resize.jBox-' + this.id);
			}
			
			// Mousemove events
			this.options.target == 'mouse' && ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('body').off('mousemove.jBox-' + this.id);
		};
		...
		this._addOverlay = function() {
			...
			if (!this.overlay) {
				...
				this.overlay = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('#jBox-overlay').length ? ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('#jBox-overlay').css({zIndex: Math.min(../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('#jBox-overlay').css('z-index'), (this.options.zIndex - 1))}) : (../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('<div/>', {id: 'jBox-overlay'}).css({display: 'none', opacity: 0, zIndex: (this.options.zIndex - 1)}).appendTo(../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('body')));
				
				// Add close button to overlay
				(this.options.closeButton == 'overlay' || this.options.closeButton === true) && ((../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('#jBox-overlay .jBox-closeButton').length > 0) ? ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('#jBox-overlay .jBox-closeButton').on('touchend click', function() { this.isOpen && this.close({ignoreDelay: true}); }.bind(this)) : this.overlay.append(this.closeButton));
		...
		this._removeOverlay = function() {
			...
			if (../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.isEmptyObject(overlay_data)) {
		...
		this._generateCSS = function() {
			...
			(../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.type(this.options.animation) != 'object') && (this.options.animation = {
			...
			../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.each(['pulse', 'tada'], function(index, item) { animations[item + 'Open'] = animations[item + 'Close'] = animations[item]; });
			...
			var generateKeyframeCSS = function(ev, position) {
				...
				../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.each(animations[this.options.animation[ev]].css, function(index, item) {
			...
			var css = '';
			../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.each(['open', 'close'], function(index, ev) {
				// No CSS needed for closing with no fade
				if (!this.options.animation[ev] || !animations[this.options.animation[ev]] || (ev == 'close' && !this.options.fade)) return '';
				
				// Generate CSS
				animations[this.options.animation[ev]].positions ?
					../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.each(['top', 'right', 'bottom', 'left'], function(index2, position) { css += generateKeyframeCSS(ev, position); }) :
					css += generateKeyframeCSS(ev);
			}.bind(this));
			
			../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('<style/>').append(css).appendTo(../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('head'));
		};
		...
		this._adjustPosition = function() {
			...
			var win = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(window);
	...
	jBox.prototype.attach = function(elements, trigger) {
		elements || (elements = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(this.options.attach.selector || this.options.attach));
		trigger || (trigger = this.options.trigger);
		
		elements && elements.length && ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.each(elements, function(index, el) {
			el = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(el);
			if (!el.data('jBox-attached-' + this.id)) {
				...
				(this.options.trigger == 'mouseenter') && el.on('mouseleave', function(ev) {
					...
					if(!this.options.closeOnMouseleave || !(ev.relatedTarget == this.wrapper[0] || ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(ev.relatedTarget).parents('#' + this.id).length)) this.close();
				}.bind(this));
	...
	jBox.prototype.detach = function(elements) {
		...
		elements && elements.length && ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.each(elements, function(index, el) {
			...
			this.attachedElements = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.grep(this.attachedElements, function(value) {
				return value != el[0];
			});
		}.bind(this));
	...
	jBox.prototype.setTitle = function(title, ignore_positioning) {
		...
		if (!this.title) {
			this.titleContainer = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('<div/>', {'class': 'jBox-title'});
			this.title = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('<div/>').appendTo(this.titleContainer);
	...
	jBox.prototype.setContent = function(content, ignore_positioning) {
		...
		var bodyHeight = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('body').height(), bodyWidth = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('body').width();
		
		// Extract all appended containers to body
		this.content.children('[data-jbox-content-appended]').appendTo('body').css({display: 'none'});
		
		// Set the new content
		switch (../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.type(content)) {
		...
		var adjustOffset = {
			x: bodyWidth - ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('body').width(),
			y: bodyHeight - ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('body').height()
		};
	...
	jBox.prototype.position = function(options, keep_position) {
		...
		// Get target
		this.target = options.target || this.target || this.options.target || ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(window);
		...
		!this.target.data('jBox-fixed') && this.target.data('jBox-fixed', (this.target[0] != ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(window)[0] && (this.target.css('position') == 'fixed' || this.target.parents().filter(function() { return ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(this).css('position') == 'fixed'; }).length > 0)) ? 'fixed' : 'static');
		
		// When the target is fixed and jBox is fixed, remove scroll offset
		if (this.target.data('jBox-fixed') == 'fixed' && this.options.fixed) {
			targetOffset.top = targetOffset.top - ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(window).scrollTop();
			targetOffset.left = targetOffset.left - ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(window).scrollLeft();
		}
		...
		var setPosition = function(p) {
			...
			if (../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.inArray(this.options.position[p], ['top', 'right', 'bottom', 'left', 'center']) == -1) {
		...
		if (this.options.pointer && ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.type(this.options.position.x) != 'number' && ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.type(this.options.position.y) != 'number') {
			...
			switch (this.pointer.align) {
				...
				switch (this.options.position[this._getOpp(this.options.outside)]) {
					...
					default:
						...
						(this.dimensions[this._getOpp(this.options.outside)] * (../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.inArray(this.pointer.align, ['top', 'left']) !== -1 ? 1 : -1)) + ((this.pointer.dimensions[this._getOpp(this.options.outside)] / 2) * (../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.inArray(this.pointer.align, ['top', 'left']) !== -1 ? -1 : 1)) :
							
						// If pointer align is same as position align
						(this.pointer.dimensions[this._getOpp(this.options.outside)] / 2) * (../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.inArray(this.pointer.align, ['top', 'left']) !== -1 ? 1 : -1);
					break;
				}
				break;
			}
	...
	jBox.prototype.open = function(options) {
		...
		var open = function() {
			...
			if (!this.isOpen) {
				...
				// Block scrolling
				this.options.blockScroll && ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('body').addClass('jBox-blockScroll-' + this.id);
	...
	jBox.prototype.close = function(options) {
		...
		var close = function() {
			...
			if (this.isOpen) {
				...
				// Unblock scrolling
				this.options.blockScroll && ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('body').removeClass('jBox-blockScroll-' + this.id);
	...
	jBox.prototype.ajax = function(options) {
		...
		var sysOptions = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.extend(true, {}, this.options.ajax);
		...
		// Merge options
		var userOptions = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.extend(true, sysOptions, options);
		...
		userOptions.beforeSend = function () {
			...
			if (userOptions.spinner) {
				this.wrapper.addClass('jBox-loading');
				this.spinner = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery(userOptions.spinner !== true ? userOptions.spinner : '<div class="jBox-spinner"></div>').appendTo(this.container);
			}
		...
		this.ajaxRequest = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.ajax(userOptions);
	...
	jBox.prototype.audio = function(options) {
		...
		if (!jBox._audio[options.url]) {
			var audio = ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('<audio/>');
			../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('<source/>', {src: options.url + '.mp3'}).appendTo(audio);
			../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery('<source/>', {src: options.url + '.ogg'}).appendTo(audio);
	...
	// Make jBox usable with ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery selectors
	../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.fn.jBox = function(type, options) {
		type || (type = {});
		options || (options = {});
		return new jBox(type, ../../../../../../weixinpl/back_newshops/PcShop/Base/index_custom/js/jQuery.extend(options, {attach: this}));
	};
