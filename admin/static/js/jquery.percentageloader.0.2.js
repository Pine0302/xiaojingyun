      ...
      var settings, canvas, percentageText, valueText, items, i, item, selectors, s, ctx, progress,
        ...
        * than true / false */
        ...
        drawLoader = function () {
            ...
            /*** TEXT ***/
            (function () {
                var fontSize, string, smallSize, heightRemaining,newFoneSize;
                ...
                smallSize = cX / 5.5;
                newFoneSize = smallSize / 1.3; //@lml 修改源码-警告信息字体大小
                valueText.style.color = '#80a9c8';
                valueText.style.font = newFoneSize.toString() + 'px BebasNeueRegular';
