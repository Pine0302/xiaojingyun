			...
			<div class="WSY_data">
					...
					<dl class="WSY_member">					
						<div>
							<dt>彩铃价格：</dt>
							<dd class="spa">
								<input onkeyup="prices(this)" type=text value="0.00" maxlength="12" placeholder="价格" name="price" id="price" style="width:300px;" />
							</dd>
						...
						<div>
							...
							<dd class="spa">
								<div style="width: 200px;height: 200px;border: 1px solid #ccc;" id='images'>
									<img src="\resources\cailing\image\default.jpg" style="width: 200px;height: 200px;">
									<input type="hidden" name="img_url" id="img_url" value="/resources/cailing/image/default.jpg">
								</div><br />
					...
					<dl class="WSY_member">					
						<div>
							...
							<dd class="spa">
								...
								<div id="uploader" style="margin: auto;margin-top: -6px;">  
					...
					<dl class="WSY_member">					
						<div>
							<dt>彩铃排序：</dt>
							<dd class="spa">
								<input  onkeyup='this.value=this.value.replace(/\D/gi,"");' onchange="sort(this)" maxlength="9" type=text value="0" name="sort" id="sort" style="width:300px;margin-bottom: 10px;margin-right: 32px;" placeholder="不填或为0默认为时间排序" /><span id="_span" style="color: red;"></span><br />
...
<script type="text/javascript">
	...
	function sort(obj){
		var val = $(obj).val();
		if(val != '' && val != '0'){
			$.post('/mshop/admin/index?m=cailing&a=setting_sort',{sort:val},function(res){
