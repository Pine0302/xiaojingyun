...
$destination_folder = "../../../../".Base_Upload."Base/personalization/distributor_article/";  
...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
 ...
 echo "<script>location.href='add_distributor_article_image.php?customer_id=".$customer_id_en."&article_imgurl=".$save_destination."';</script>";
 }
?>