...
<?php }?>
<div id="products" class="r_con_wrap" style="background:none;margin-top:7px;margin-right:5px;">
<span class="input">
<span class="upload_file">  
	<div>
	   <form action="save_pro_logo.php?customer_id=<?php echo $customer_id_en; ?>" id="frm_img" enctype="multipart/form-data" method="post">
			...
			<?php if(!empty($type_imgurl)){ ?>
				<div id="type_imgurl" style="text-align:center;height:120px;">
					<a href="<?php echo $new_baseurl.$type_imgurl; ?>" target="_blank" id="type_imgurl">		
						<img style="max-width:100%;height:121px;display:inline-block;" src="<?php echo $new_baseurl.$type_imgurl; ?>">
					</a>			
				</div>	
			<?php }else{?>
...
<!--<div class="uploader white">
	<input type="text" class="filename" readonly/>
	<input type="button" name="file" class="button" value="上传..."/>
	<input type="file" name="upfile" id="upfile" value="Submit" size="20"/>
</div>
-->
</span>  
<div class="clear"></div>
