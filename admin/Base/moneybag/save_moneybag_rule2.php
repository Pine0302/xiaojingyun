...
if($id<0){
		...
		$sql = "UPDATE moneybag_rule SET createtime=now(),
										 isOpen_massage=$isOpen_massage,
										 isopen_poundage=$isopen_poundage,
										 poundage_percentage=$poundage_percentage 
									  WHERE id=$id";
...
echo "<script>window.location.href='./payset.php?customer_id=".$customer_id_en."'</script>";
