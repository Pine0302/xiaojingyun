...
<div class="WSY_column_header1">
	<div class="WSY_columnnav1">
		<ul>			
			<li value="0"><a href="/mshop/admin/index.php?m=exchange&a=exchange_activity_list">满赠活动</a></li>
			<!-- <li value="1"><a href="/mshop/admin/index.php?m=exchange&a=ex_exchange">添加活动</a></li>			 -->
			<li value="1"><a href="/mshop/admin/index.php?m=exchange&a=operation_log">操作日志</a></li>			
		</ul>
	</div>
</div>
<script>
