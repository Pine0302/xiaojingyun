...
{{? it.content.css_type==1}}
<div style="height:40px;line-height:40px;background-color:#fef7ee;border:1px solid #ffcc74;padding-left:34px;background-image:url(<?php echo $new_baseurl;?>/weixinpl/common_shop/common/custom_temp/images/laba01.png);background-repeat:no-repeat;background-position:10px 9px;background-size:20px 20px;">
...
{{?? it.content.css_type==2}}
<div style="height:40px;line-height:40px;background-color:#ffebed;border:1px solid #f7929c;padding-left:34px;background-image:url(<?php echo $new_baseurl;?>/weixinpl/common_shop/common/custom_temp/images/laba02.png);background-repeat:no-repeat;background-position:10px 9px;background-size:20px 20px;">
	<div id="marquee{{= it.id}}" class="marquee">
		<ul>
		{{for (var j=0,k=it.content.dataset.length;j<k;j++) { }}
...
<div style="height:40px;line-height:40px;background-color:#f6fee7;border:1px solid #b4e14d;padding-left:34px;background-image:url(<?php echo $new_baseurl;?>/weixinpl/common_shop/common/custom_temp/images/laba03.png);background-repeat:no-repeat;background-position:10px 9px;background-size:20px 20px;">
	<div id="marquee{{= it.id}}" class="marquee">
		<ul>
		{{for (var j=0,k=it.content.dataset.length;j<k;j++) { }}
...
<div style="height:40px;line-height:40px;background-color:#dff9ff;border:1px solid #78c3d4;padding-left:34px;background-image:url(<?php echo $new_baseurl;?>/weixinpl/common_shop/common/custom_temp/images/laba04.png);background-repeat:no-repeat;background-position:10px 9px;background-size:20px 20px;">
	<div id="marquee{{= it.id}}" class="marquee">
		<ul>
		{{for (var j=0,k=it.content.dataset.length;j<k;j++) { }}
...
<div style="height:40px;line-height:40px;background-color:#fcecff;border:1px solid #efabff;padding-left:34px;background-image:url(<?php echo $new_baseurl;?>/weixinpl/common_shop/common/custom_temp/images/laba05.png);background-repeat:no-repeat;background-position:10px 9px;background-size:20px 20px;">
	<div id="marquee{{= it.id}}" class="marquee">
		<ul>
		{{for (var j=0,k=it.content.dataset.length;j<k;j++) { }}
...
<div class="con_display" {{? it.content.padding}}style="padding:{{= it.content.padding}}px 0;"{{?}}> 
      {{? it.content.css_type==1}}
      <div class="top-main01 back-img" style="background-image:url({{=it.content.icon_pic}})">
          ...
          {{?? it.content.css_type==2}}
            <div class="top-main02 back-img" style="background-image:url({{=it.content.icon_pic}}) no-repeat;">
          ...
          {{?? it.content.css_type==3}}
          <div class="top-main03 back-img" style="background-image:url({{=it.content.icon_pic}}) no-repeat;">
          ...
          {{?? it.content.css_type==4}}
          <div class="top-main04 back-img" style="background-image:url({{=it.content.icon_pic}}) no-repeat;">
			<span class="top-set">设置</span>
			<div class="top-imgBox">
				头像
			</div>
