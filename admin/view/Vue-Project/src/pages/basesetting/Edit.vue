      ...
      <div class="WSY_columnbox">
        <div class="WSY_remind_main">
          ...
          <div class="tab-one">
            ...
            <div class="tab-one-line">
              <span class="tab-one-title">消费积分</span>
              <div class="tab-one-radio">
            ...
            <div class="tab-one-line">
              <span class="tab-one-title">推荐积分</span>
              <div class="tab-one-radio">
                <input v-bind:disabled="isReadOnly" type="radio" name="recommend_typen" v-model="tableDataM.recommend_type" value="2" @click="changeFun()">
                <span>固定积分</span></div>
              <div class="tab-one-radio">
                <input v-bind:disabled="isReadOnly" type="radio" name="recommend_typen" v-model="tableDataM.recommend_type" value="1" @click="changeFun()">
                <span>固定比例</span></div>
            </div>
          </div>
          <dl class="WSY_remind_dl02">
              ...
              <div class="total_set_box">
                ...
                <div class="edit_set_tab procan">
                  ...
                  <div class="edit_set_tab_line edit_set_tab_line3">
                    <div class="line3_box">
                      <span class="edit_set_tab_des">消费积分</span>
                    ...
                    <div class="line3_box">
                      <span class="edit_set_tab_des">推荐积分</span>
                      <div class="WSY_dd_div" v-show="tableDataM.recommend_type==2">
                        <input v-bind:readonly="isReadOnly" class="WSY_small_ipt" type="number" name="recommend_type1" v-model="tableDataM.recommend_integral">
                        <span class="integralone">积分</span>
                        <span>换算结果</span>
                        <span>{{recommendintegralresfun1}}</span>
                      </div>
                      <div class="WSY_dd_div" v-show="tableDataM.recommend_type==1">
                        <input v-bind:readonly="isReadOnly" class="WSY_small_ipt" type="number" name="recommend_type2" v-model="tableDataM.recommend_integral">
                        <span class="integralone">%</span>
                        <span>换算结果</span>
                        <span>{{recommendintegralresfun2}}</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="edit_set_tab_right">
                    ...
                    <div class="edit_set_tab_line edit_set_tab_line3">
                      <div class="line3_box">
                        ...
                        <span class="edit_set_tab_des">推荐积分</span>
                        <div class="edit_set_tab_radio">
                          <span v-if="tableDataM.recommend_type == 2">固定积分</span>
                          <span v-else-if="tableDataM.recommend_type == 1">固定比例</span>
                          <input v-bind:readonly="isReadOnly" type="text" class="WSY_small_ipt" @input="countVal2($event.target.value,itemi.now_price,index)" v-model="itemi.recommend_integral">
                          <span v-if="tableDataM.recommend_type == 1">%</span>
                        </div>
                      </div>
                      <div class="line3_box">
                        ...
                        <span class="edit_set_tab_des">换算结果</span>
                        <div class="edit_set_tab_radio">
                          <span class="changeres2">{{itemi.res2}}</span>
                        </div>
                      </div>
                    </div>
                  </div>
...
export default {
  ...
  computed: {
    ...
    recommendintegralresfun1: function() {
      return this.tableDataM.recommend_integral;
    },
    recommendintegralresfun2: function() {
      return ((this.tableDataM.recommend_integral * this.tableDataM.now_price) / 100).toFixed(2);
    },
  ...
  methods: {
    ...
    initResFun() {
      ...
      //  if(this.tableDataM.consume_type==1){
      //    data.res1=data.now_price*data.consume_integral;
      //  }else{
      //    data.res1=(data.now_price*data.consume_integral/100).toFixed(2);
      //  }
      //  if(this.tableDataM.recommend_type==1){
      //    data.res2=data.now_price*data.recommend_integral;
      //  }else{
    ...
    modeFun(event) {
      if (event == 1) {
        ...
        //0按比例1按固定积分
        if (this.tableDataM.gift_set_type == 0) {
    ...
    commit() {
      ...
      self.$http.post(urlpost, {
        ...
        .then(res => {
          ...
          // });
          alert('保存成功！');
          this.$router.push({ path: '/basesetting/productmanage'});
        }).catch(err => {
          console.log(err)
        })
    }
